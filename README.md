...
| :-------------------- | :-------------------- |
| ⚡ My Repositories: |- `Yandex Projects`: Проекты, выполненные в процессе обучения в Яндекс.Практикуме по направлению Специалист Data Science - `Соревнования/хакатоны`: Проекты, выполненные в рамках соревнований, преимущественно в рамках проекта Цифровой прорыв 2022 | 
